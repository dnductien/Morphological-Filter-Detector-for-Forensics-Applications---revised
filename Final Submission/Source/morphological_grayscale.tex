...
\author{\uppercase{Giulia Boato}\authorrefmark{1,3} \IEEEmembership{Member, IEEE},
\uppercase{Duc-Tien Dang-Nguyen}\authorrefmark{2} \IEEEmembership{Member, IEEE} and \uppercase{Francesco G.B. De Natale}\authorrefmark{1,3}\IEEEmembership{Senior Member, IEEE}}
...
\tfootnote{This work has been supported by the PRIN PREMIER project.}
